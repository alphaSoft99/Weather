...
class ItemViewModel : ViewModel() {
    ...
    private val _postLiveData = MutableLiveData<ItemViewResponse>()
    val postLiveData: LiveData<ItemViewResponse> = _postLiveData
    ...
    fun get(context: Context, id: String) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val response = api.getItem(preference.getUiLocale(), id)
