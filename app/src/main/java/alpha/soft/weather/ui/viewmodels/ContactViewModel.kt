...
class ContactViewModel : ViewModel() {
    ...
    private val _postLiveData = MutableLiveData<ContactData>()
    val postLiveData: LiveData<ContactData> = _postLiveData
    ...
    fun get(context: Context) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val response = api.getContact(preference.getUiLocale())
